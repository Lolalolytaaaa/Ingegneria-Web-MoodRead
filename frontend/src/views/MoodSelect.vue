...
<template>
  <div class="pt-6 pb-10 px-4 min-h-screen bg-white">
    ...
    <div class="flex justify-center mt-12 mb-10">
      <router-link to="/results" class="bg-mood-dark text-white font-display text-2xl uppercase px-16 py-4 rounded-full shadow-2xl hover:scale-105 hover:bg-mood-dark/90 transition-all duration-300">
        leggi il tuo mood
      </router-link>
    </div>
